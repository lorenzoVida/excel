...
import utils.video.ScreenRecorderUtil;
...
public class windowHandleSeleniumStep {
    ...
    public void click_en_window_handle_button() throws Exception {
        ScreenRecorderUtil.startRecord("click_en_window_handle_button");
    driver.findElement(By.id("openwindow")).click();
    driver.findElement(By.id("name")).sendKeys("Yessenia");

    }
    @Then("navigate in the new Window")
    public void navigate_in_the_new_window() throws Exception {
